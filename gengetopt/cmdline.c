...
const char *gengetopt_args_info_purpose = "Sample application description.\n\nBy Akagi201 <akagi201@gmail.com>";

const char *gengetopt_args_info_usage = "Usage: app [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --filename=STRING      String argument",
  "  -s, --size=INT             Optional argument, takes exactly 3 int values\n                               separated by commas",
  "  -a, --array=INT            Required argument, takes 1 or more args",
  "      --long-option=FLOAT    Option without short version",
  "  -d, --default-value=FLOAT  Argument with default value  (default=`0.003')",
  "  -c, --console              Flag with default 'off'  (default=off)",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->array_given = 0 ;
  args_info->long_option_given = 0 ;
  args_info->default_value_given = 0 ;
  args_info->console_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->array_arg = NULL;
  args_info->array_orig = NULL;
  args_info->long_option_orig = NULL;
  args_info->default_value_arg = 0.003;
  args_info->default_value_orig = NULL;
  args_info->console_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->size_help = gengetopt_args_info_help[3] ;
  args_info->size_min = 3;
  args_info->size_max = 3;
  args_info->array_help = gengetopt_args_info_help[4] ;
  args_info->array_min = 1;
  args_info->array_max = 0;
  args_info->long_option_help = gengetopt_args_info_help[5] ;
  args_info->default_value_help = gengetopt_args_info_help[6] ;
  args_info->console_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  args_info->size_arg = 0;
  free_multiple_field (args_info->array_given, (void *)(args_info->array_arg), &(args_info->array_orig));
  args_info->array_arg = 0;
  free_string_field (&(args_info->long_option_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->array_given, "array", args_info->array_orig, 0);
  if (args_info->long_option_given)
    write_into_file(outfile, "long-option", args_info->long_option_orig, 0);
  if (args_info->default_value_given)
    write_into_file(outfile, "default-value", args_info->default_value_orig, 0);
  if (args_info->console_given)
    write_into_file(outfile, "console", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->size_given, args_info->size_min, args_info->size_max, "'--size' ('-s')"))
     error_occurred = 1;
  
  if (! args_info->array_given)
    {
      fprintf (stderr, "%s: '--array' ('-a') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->array_given, args_info->array_min, args_info->array_max, "'--array' ('-a')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * array_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVf:s:a:d:c", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* String argument.  */
          ...
          break;
        case 's':	/* Optional argument, takes exactly 3 int values separated by commas.  */
          ...
          break;
        case 'a':	/* Required argument, takes 1 or more args.  */
        
          if (update_multiple_arg_temp(&array_list, 
              &(local_args_info.array_given), optarg, 0, 0, ARG_INT,
              "array", 'a',
              additional_error))
            goto failure;
        
          break;
        case 'd':	/* Argument with default value.  */
        
        
          if (update_arg( (void *)&(args_info->default_value_arg), 
               &(args_info->default_value_orig), &(args_info->default_value_given),
              &(local_args_info.default_value_given), optarg, 0, "0.003", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "default-value", 'd',
              additional_error))
            goto failure;
          ...
          break;
        case 'c':	/* Flag with default 'off'.  */
        
        
          if (update_arg((void *)&(args_info->console_flag), 0, &(args_info->console_given),
              &(local_args_info.console_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "console", 'c',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          /* Option without short version.  */
          if (strcmp (long_options[option_index].name, "long-option") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->long_option_arg), 
                 &(args_info->long_option_orig), &(args_info->long_option_given),
                &(local_args_info.long_option_given), optarg, 0, 0, ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "long-option", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->size_arg),
    ...
    ARG_INT, size_list);
  update_multiple_arg((void *)&(args_info->array_arg),
    &(args_info->array_orig), args_info->array_given,
    local_args_info.array_given, 0,
    ARG_INT, array_list);

  args_info->size_given += local_args_info.size_given;
  local_args_info.size_given = 0;
  args_info->array_given += local_args_info.array_given;
  local_args_info.array_given = 0;
